...
\begin{figure}
	...
	\caption{Visualization of the work flow for the extraction of the acinar volumes: %
		...
		\subref{subfig:manhole covers} Extracted acini (yellow). Several extracted acini are shown superimposed over the sample in \threed. For each such acinus we recorded the volume.%
		}
	\label{fig:workflow}
\end{figure}
