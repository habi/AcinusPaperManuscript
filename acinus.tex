...
\newcommand{\meantotalnumberofacinirounded}{6433}
\newcommand{\meanacinarvolume}{0.00114780352468} % cm^3, (mean acinar volume)
\newcommand{\std}{0.000321884288889} % (Standard deviation of acinar volumes)
\newcommand{\meannumberofalveoli}{8470} % (Mean number of alveoli per acinus)
\newcommand{\difference}{2.66094871795} % X times bigger (acinar volumes STEPanizer/MeVisLab-volumes)
\newcommand{\acinarsurface}{0.738990108332} % cm^2
\newcommand{\meanairspacesurface}{4339.86703774} % cm^2
\newcommand{\airspacedifference}{1.848} % times
\newcommand{\biggerthan}{1234} % Outliers bigger/smaller than mean +- BiggerThan * STD have been removed'
...
Assuming that the acini are similarly sized throughout the different regions in the lung, we calculated a number of acini per animal of approximately \meantotalnumberofacinirounded.
...
\begin{figure}
	\centering
	\subfloat[MeVis]{
		\input{plots/plot_mevisvolume_R108C60B_B1_mrg.tikz}%
		}
	\subfloat[MeVis]{
		\input{plots/plot_mevisvolume_R108C60Dt-mrg.tikz}
		}
	\subfloat[MeVis]{
		\input{plots/plot_mevisvolume_R108C60Et-mrg.tikz}
		}\\
	\subfloat[STEPanizer]{
		\input{plots/plot_stepanizervolume_R108C60B_B1_mrg.tikz}
		}
	\subfloat[STEPanizer]{
		\input{plots/plot_stepanizervolume_R108C60Dt-mrg.tikz}
		}
	\subfloat[STEPanizer]{
		\input{plots/plot_stepanizervolume_R108C60Et-mrg.tikz}
		}
