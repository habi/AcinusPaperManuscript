...
\begin{figure}
	...
	\todo[inline]{Do we need/want this figure? If yes, we need a copyright release.}
\end{figure}
...
\begin{figure}
	...
	\todo[inline]{The scalebar is {\color{red} TEMPORARILY} copy-pasted over the image for scale bar scaling reasons.}
\end{figure}
