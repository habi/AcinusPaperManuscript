...
\newcommand{\acinarvolumeB}{0.693} % mm^3 (changed from cm^3 to mm^3 in ReadVolumeSurfaceAndAlveaolarNumber.py)
...
\newcommand{\meanacinarsurface}{73.9} % mm^2
...
The airway structure of the mammalian lung is formed from largely dichotomous branches~\cite{Weibel1991} starting from the trachea.
