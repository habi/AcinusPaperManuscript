...
\begin{figure}
	...
	\caption{Screenshot from the STEPanizer counting window.
		...
		Line and point probes used for counting are shown as red lines and green circles. Counting events are marked as yellow circles. 
...
Rat lungs are obviously larger than mice lungs.  Based on the strains we studied (SV 127 mice versus Sprague-Dawley rats, \citep{Mund2008,Schittny2008}) an 60 days old rat possesses an approximately 20\(\times\) larger parenchymal volume than a mouse of the same age (8932 vs.\ \SI{444}{\cubic\milli\meter}, \citep{Tschanz2003} vs.\ \citep{Mund2008}).
...
We indeed observed a mean of \meannumberofalveoli\xspace alveoli per rat acinus, which is nearly ten times the number of alveoli in mice acini.
...
A value of  \meantotalnumberofacini\xspace acini per rat lung was obtained by dividing the total parenchymal volume by the mean acinar volume, as discussed in \autoref{sec:results:total number of acini}.
...
In the images we analzyed the border between the tissue (septum) and the airspace does not represent an sharp top-hat like profile but looks more like a slope profile.
