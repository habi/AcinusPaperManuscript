...
\begin{figure}
	...
	\caption{Acinar volumes of each sample, extracted with MeVisLab and the STEPanizer. The dashed line corresponds to the mean, the dotted lines correspond to the mean \(\pm\biggerthan\times\) the standard deviation. Top row: MeVisLab volumes, bottom row: STEPanizer volumes. From left to right: animal B, D and E.}
