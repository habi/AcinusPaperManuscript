...
\begin{figure}[htb]
	\centering
	\begin{tikzpicture}
		\pgfplotsset{every axis plot/.append style={thick,semitransparent}}
		\begin{semilogyaxis}[
			xlabel=Acinus,
			...
			\addplot+[mark=none]
				table [x=Segment,y=Volume] {plots/R108C04At.txt};
			\addplot+[mark=none]
				table [x=Segment,y=Volume] {plots/R108C10C.txt};
			\addplot+[mark=none]
				table [x=Segment,y=Volume] {plots/R108C21D.txt};
			\addplot+[mark=none]
				table [x=Segment,y=Volume] {plots/R108C36A.txt};
			\addplot+[mark=none]
				table [x=Segment,y=Volume] {plots/R108C60B.txt};
			\legend{R108C04At,%
				R108C10C,%
				R108C21D,%
				R108C36A,%
