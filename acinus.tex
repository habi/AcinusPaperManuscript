...
\replaced[id=dh]{The extraction we performed}{It} \replaced[id=sb]{allows}{enabled} us to obtain \removed[id=ms]{statistical} data on acinar volume, surface area and numbers of alveoli per acinus.}
