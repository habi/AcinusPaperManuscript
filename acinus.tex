...
%\JCStrue
\ifJCS
	\documentclass[paper=a4,DIV=calc,abstract,english]{scrartcl}
...
We have only shown data for one time point in the lung development, but a stereological estimation of the presented parameters would also be possible for multiple time points during lung development or in different disease models like fibrosis or \replaced[id=rev1]{emphzsematous}{emphysematic} lungs.
