...
\subsection{Lung structure}
\begin{itemize}
	\item Lung structure, from pipes to bags.
	\item Changes in airway wall structure make it possible to extract acinus
	\item Changes from pipe to pipe with outouchings
	\item Do we need \autoref{fig:acinus schematic}
