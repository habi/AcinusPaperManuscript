...
The volume was estimated according to the Cavalieri principle: \added[id=dh]{the} profile area on equidistant serial sections of acini was estimated by simple point counting.
...
To our best knowledge, an extraction of such a \replaced[id=dh]{large}{high} number of rat lung acini from high-resolution tomographic datasets has never been achieved before.
...
\subsection{Number of alveoli per acinus}
We found \(\meannumberofalveoli\pm\meannumberofalveoliSTD\) alveoli per acinus showing a considerabl\replaced[id=dh]{y large}{e high} deviation.
...
We thus did not assess the acinar surface by triangulation, but used a \deleted[id=js]{a }classic stereological \replaced[id=js]{approach}{way} to estimate the surface area of the acini.
